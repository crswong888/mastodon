...
[VectorPostprocessors]
  ...
  [./soil_accel_hist]
    ...
    variables = accel_x
    nodes = '47879 47916 168 59479 77013 25821' # corner, edge, and center at the top and middle
  [../]
  [./soil_spectrum]
  ...
  [./reactor_accel_hist]
    type = ResponseHistoryBuilder
    variables = accel_x
    nodes = '404737 409541 404695 405084 404762' # top front/center/right and mid front/right
  [../]
  [./reactor_spectrum]
    type = ResponseSpectraCalculator
