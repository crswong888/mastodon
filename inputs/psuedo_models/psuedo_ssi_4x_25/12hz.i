...
[VectorPostprocessors]
  ...
  [./soil_accel_hist]
    ...
    variables = accel_x
    nodes = '43841 43878 168 55441 72975 21783' # corner, edge, and center at the top and middle
  [../]
  [./soil_spectrum]
  ...
  [./reactor_accel_hist]
    type = ResponseHistoryBuilder
    variables = accel_x
    nodes = '401035 405503 400993 401292 401054' # top front/center/right and mid front/right
  [../]
  [./reactor_spectrum]
    type = ResponseSpectraCalculator
...
[Outputs]
  ...
  [./exodus]
    type = Exodus
    file_base = ../../../../../../../scratch/wongchri/efe/psuedo_models/psuedo_ssi_4x_25/12hz_out # write to scratch storage
  [../]
  [./screen]
    type = Console
    interval = 10
