...
[VectorPostprocessors]
  ...
  [./soil_accel_hist]
    ...
    variables = accel_x
    nodes = '0 37 2808 10761 28080 204444' # corner, edge, and center at the top and middle
    use_displaced_mesh = true
  [../]
  [./soil_spectrum]
  ...
  [./reactor_accel_hist]
    type = ResponseHistoryBuilder
    variables = accel_x
    nodes = '379913 385222 379871 380260 379932' # top front/center/right and mid front/right
    use_displaced_mesh = true
  [../]
  [./reactor_spectrum]
    type = ResponseSpectraCalculator
...
[Outputs]
  ...
  [./exodus]
    type = Exodus
    file_base = ../../../../../../../scratch/wongchri/efe/psuedo_models/psuedo_nlssi_4x/12hz_out # write to scratch storage
  [../]
  [./screen]
    type = Console
    interval = 10
