...
[Functions]
  [./vel_input]
    ...
    data_file = ../4hz.csv # IF(t<4.44, .03*2*pi*f*cos(2*pi*f*t), 0)
    format = columns
  [../]
[]
...
[Outputs]
  ...
  [./soil_history]
    type = CSV
    file_base = ./spreadsheets/4hz_soil_history
  ...
  [./reactor_history]
    type = CSV
    file_base = ./spreadsheets/4hz_reactor_history
