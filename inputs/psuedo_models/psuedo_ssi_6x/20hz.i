...
[Functions]
  [./vel_input]
    ...
    data_file = ../20hz.csv # IF(t<0.7625, .03*2*pi*f*cos(2*pi*f*t), 0)
    format = columns
  [../]
[]
...
[BCs]
  ...
  [./Periodic]
    [./x_dir]
      ...
      primary = left
      secondary = right
      translation = '43.2 0.0 0.0'
    [../]
    [./y_dir]
      variable = 'disp_x disp_y disp_z'
      primary = front
      secondary = back
      translation = '0.0 43.2 0.0'
    [../]
  [../]
...
[VectorPostprocessors]
  ...
  [./soil_accel_hist]
    ...
    variables = accel_x
    nodes = '48257 47934 168 69793 92403 25821' # corner, edge, and center at the top and middle
  [../]
  [./soil_spectrum]
    type = ResponseSpectraCalculator
    vectorpostprocessor = soil_accel_hist
    regularize_dt = 0.0005
    end_frequency = 30.0
  ...
  [./reactor_accel_hist]
    type = ResponseHistoryBuilder
    variables = accel_x
    nodes = '869929 874733 869887 870276 869954' # top front/center/right and mid front/right
  [../]
  [./reactor_spectrum]
    type = ResponseSpectraCalculator
...
[Outputs]
  ...
  [./soil_history]
    type = CSV
    file_base = ./spreadsheets/20hz_soil_history
  ...
  [./reactor_history]
    type = CSV
    file_base = ./spreadsheets/20hz_reactor_history
