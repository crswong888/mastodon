...
[Mesh]
  type = FileMesh
  file = ./gravity_embed_continuous_initialize_cp/LATEST
...
[Problem]
  restart_file_base = ./gravity_embed_continuous_initialize_cp/LATEST
[]
...
[BCs]
  ...
  [../]
  [./apply_vel_small_x]
    # This input is for comparing to the embeded model with the discontinuous contact surface
    type = PresetVelocity
    variable = disp_x
    boundary = bottom
    function = vel_input_small
    use_displaced_mesh = true
    enable = false
  [../]
  [./apply_vel_large_x]
    # This input is for comparing to the surface sitting model.
    type = PresetVelocity
    variable = disp_x
    boundary = bottom
    function = vel_input_large
    use_displaced_mesh = true
    enable = true
  [../]
  [./Periodic]
