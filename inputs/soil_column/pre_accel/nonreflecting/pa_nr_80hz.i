# This one appears to filter out the high frequency since
# the max input frequency of 85.18-Hz is nearly exceeded.
...
[Functions]
  [./accel_input]
    ...
    data_file = ../pa_80hz.csv # IF(t<2.0, -(2*pi*f)^2*sin(2*pi*f*t), 0)
    format = columns
  [../]
[]
...
[Outputs]
  ...
  [./history]
    type = CSV
    file_base = ./spreadsheets/pa_nr_80hz_history
    hide = 'accel_hist spectrum'
  [../]
  [./spectrum]
    type = CSV
    file_base = ./spreadsheets/pa_nr_80hz
    show = spectrum
    execute_on = FINAL
  [../]
[]
