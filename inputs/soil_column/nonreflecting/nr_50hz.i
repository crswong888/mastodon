# This one is wierd, the way displacements are derived
# using PresetVelocity, dt = 0.01s, and 50hz, seems
# to be a sweet spot for 0 oscillations during loading.
...
[Functions]
  [./vel_input]
    ...
    data_file = ../50hz.csv # IF(t<2.025, 2*pi*f*cos(2*pi*f*t), 0)
    format = columns
  [../]
[]
...
[Outputs]
  ...
  [./history]
    type = CSV
    file_base = ./spreadsheets/nr_50hz_history
    hide = 'accel_hist spectrum'
  [../]
  [./spectrum]
    type = CSV
    file_base = ./spreadsheets/nr_50hz
    show = spectrum
    execute_on = FINAL
  [../]
[]
